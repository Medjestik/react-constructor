...
function EditPerformersPopup({ isOpen, onClose, onEdit, performer, isLoading, isShowError }) { 
  ...
  React.useEffect(() => {
    ...
    setErrorLastname(false);
    setMiddlename(performer.middlename);
    setErrorMiddlename(false);
    setTask(performer.task);
    setTitle(performer.title);
    setTitleShort(performer.titleShort);
    setDegree(performer.degree);
    setDegreeShort(performer.degreeShort);
    setErrorTask(false);
      ...
      <form className="popup__form popup__form_type_large" name="control-performer-add-form" action="#" noValidate onSubmit={handleSubmit}>
        ...
        <ul className="initial-popup__list-input">
          ...
          <li className="initial-popup__item-input">
            ...
            defaultValue={{ label: performer.title, value: performer.titleShort }}
          ...
          <li className="initial-popup__item-input">
            ...
            defaultValue={{ label: performer.degree, value: performer.degreeShort }}
...
export default EditPerformersPopup;