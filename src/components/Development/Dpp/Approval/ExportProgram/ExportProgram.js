    ...
    <div className="export-program">
      ...
      <ul className="export-program__export-list">
        <li className="export-program__export-item">
          ...
          <a className="btn export-program__btn" href={`https://constructor.emiit.ru:8887/dpps/${dppDescription.id}/export_dpp`} target="_blank" rel="noreferrer">Экспорт в Word</a>
        </li>
        <li className="export-program__export-item">
          <div className="export-program__export-info">
          ...
          <a className="btn export-program__btn" href={`https://constructor.emiit.ru:8887/dpps/${dppDescription.id}/export_om`} target="_blank" rel="noreferrer">Экспорт в Word</a>
        </li>
        <li className="export-program__export-item">
          <div className="export-program__export-info">
          ...
          <a className={`btn export-program__btn ${programData.hours.lec > 0 ? "" : "export-program__btn_type_block"}`} href={`https://constructor.emiit.ru:8887/dpps/${dppDescription.id}/export_lection`} target="_blank" rel="noreferrer">Экспорт в Word</a>
        </li>
        <li className="export-program__export-item">
          <div className="export-program__export-info">
          ...
          <a className={`btn export-program__btn ${programData.hours.pr > 0 ? "" : "export-program__btn_type_block"}`} href={`https://constructor.emiit.ru:8887/dpps/${dppDescription.id}/export_practice`} target="_blank" rel="noreferrer">Экспорт в Word</a>
        </li>
        <li className="export-program__export-item">
          <div className="export-program__export-info">
          ...
          <a className={`btn export-program__btn ${programData.hours.lab > 0 ? "" : "export-program__btn_type_block"}`} href={`https://constructor.emiit.ru:8887/dpps/${dppDescription.id}/export_lab`} target="_blank" rel="noreferrer">Экспорт в Word</a>
        </li>
      </ul>
    </div>
  );
