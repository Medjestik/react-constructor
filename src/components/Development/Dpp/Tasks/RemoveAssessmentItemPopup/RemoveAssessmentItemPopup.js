...
function RemoveAssessmentItemPopup({ isOpen, onClose, currentTask, currentSubject, onConfirm, isLoadingRequest }) {

  function handleSubmit(e) {
    e.preventDefault();
    onConfirm(currentTask.id, currentSubject.id, onClose);
  }
  ...
  return (
    ...
    >
      <form className="popup__form" name="confirm-remove-object-form" action="#" noValidate onSubmit={handleSubmit}>
        ...
        <h3 className="popup__title">Вы действительно хотите удалить предмет оценки?</h3>
...
export default RemoveAssessmentItemPopup;