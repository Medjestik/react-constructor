...
function RemoveAdditionalMaterial({ isOpen, onClose, onRemoveFile, currentMaterialId, isLoading }) {

  function handleSubmit(e) {
    e.preventDefault();
    onRemoveFile(currentMaterialId, onClose);
  }
...
export default RemoveAdditionalMaterial; 