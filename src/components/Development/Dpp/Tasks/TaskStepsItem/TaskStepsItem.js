...
import '../../../../DragAndDrop/DraggableItem/DraggableItem.css';
import { Draggable } from 'react-beautiful-dnd';

function TaskStepItem({ part, index, onEdit, onRemove }) {
    ...
    <Draggable draggableId={part.stringIds} index={index}>
      {(provided, snapshot) => (
        ...
        >
          ...
          <h3 className={`draggable-item__text ${isShowMenu ? "draggable-item__text_type_short" : ""}`}>Шаг {index + 1}</h3>
