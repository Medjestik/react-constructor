...
function AddQualificationObjectPopup({ isOpen, onClose, onAdd, isLoading, requestMessage, clearRequestMessage }) {
  ...
  return(
    <Popup isOpen={isOpen} onClose={onClose} >
      <form className="popup__form popup__form_type_medium" name="program-data-add-qualification-obj-form" action="#" noValidate onSubmit={handleSubmit}>
        <h3 className="popup__title">Добавление нового объекта</h3>
        ...
        <div className="form__field">
          ...
          <input 
            ...
            type="text"
            id="program-data-add-qualification-obj"
            name="program-data-add-qualification-obj"
            autoComplete="off"
            value={addName}
...
export default AddQualificationObjectPopup;