...
function EditQualificationRequirementsPopup({ isOpen, onClose, data, onEdit, isLoading, requestMessage, clearRequestMessage }) {
  ...
  return(
    <Popup isOpen={isOpen} onClose={onClose} >
      <form className="popup__form popup__form_type_large" name="program-data-edit-qualification-req-form" action="#" noValidate onSubmit={handleSubmit}>
        <h3 className="popup__title">Редактирование требования</h3>
        ...
        <div className="form__field">
          ...
          <input 
            ...
            type="text"
            id="program-data-edit-qualification-req"
            name="program-data-edit-qualification-req"
            autoComplete="off"
            value={addName}
...
export default EditQualificationRequirementsPopup;