...
function OrderRussiaGosConstructionPopup({ isOpen, onClose, emptyNsi, onAdd, id, printDate }) {
  ...
  setAddFullName("Приказ Госстроя России от " + date + " г. № " + number + "" + edition + " «" + name + "»");
  ...
  return (
    ...
    >
      <form className="popup__form popup__form_type_large" name="add-nsi-form" action="#" noValidate onSubmit={handleSubmit}>
          <h3 className="nsi-popup__title">Добавление Приказа Госстроя России</h3>
...
export default OrderRussiaGosConstructionPopup;