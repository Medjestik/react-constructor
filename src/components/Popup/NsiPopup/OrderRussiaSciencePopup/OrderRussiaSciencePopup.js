...
function OrderRussiaSciencePopup({ isOpen, onClose, emptyNsi, onAdd, id, printDate }) {
  ...
  setAddFullName("Приказ Минобрнауки России от " + date + " г. № " + number + "" + edition + " «" + name + "»");
  ...
  return (
    ...
    >
      <form className="popup__form popup__form_type_large" name="add-nsi-form" action="#" noValidate onSubmit={handleSubmit}>
          <h3 className="nsi-popup__title">Добавление Приказа Минобрнауки России</h3>
...
export default OrderRussiaSciencePopup;