...
function DispositionFederalServicePopup({ isOpen, onClose, emptyNsi, onAdd, id, printDate }) {
  ...
  return (
    ...
    >
      <form className="popup__form popup__form_type_large" name="add-nsi-form" action="#" noValidate onSubmit={handleSubmit}>
          <h3 className="nsi-popup__title">Добавление Распоряжения Федеральной службы</h3>
