...
function GovernmentDecreePopup({ isOpen, onClose, emptyNsi, onAdd, id, printDate }) {
  ...
  return (
    ...
    >
      <form className="popup__form popup__form_type_large" name="edit-part-form" action="#" noValidate onSubmit={handleSubmit}>
          <h3 className="nsi-popup__title">Добавление Постановления Правительства Российской Федерации</h3>
