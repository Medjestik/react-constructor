...
function STOPopup({ isOpen, onClose, emptyNsi, onAdd, id, printDate }) {
  ...
  React.useEffect(() => { 
    ...
    setAddFullName("СТО "+ code + ". «" + name + "». " + res);
  ...
  return (
    ...
    >
      <form className="popup__form popup__form_type_large" name="add-nsi-form" action="#" noValidate onSubmit={handleSubmit}>
          <h3 className="nsi-popup__title">Добавление Стандарта организации</h3>
