...
function DispositionRussiaSciencePopup({ isOpen, onClose, emptyNsi, onAdd, id, printDate }) {
  ...
  setAddFullName("Распоряжение Минобрнауки России от " + date + " г. № " + number + "" + edition + " «" + name + "»");
  ...
  return (
    ...
    >
      <form className="popup__form popup__form_type_large" name="add-nsi-form" action="#" noValidate onSubmit={handleSubmit}>
          <h3 className="nsi-popup__title">Добавление Распоряжения Минобрнауки России</h3>
...
export default DispositionRussiaSciencePopup;