...
function OrderRussiaMinConstructionPopup({ isOpen, onClose, emptyNsi, onAdd, id, printDate }) {
  ...
  setAddFullName("Приказ Минстроя России от " + date + " г. № " + number + "" + edition + " «" + name + "»");
  ...
  return (
    ...
    >
      <form className="popup__form popup__form_type_large" name="add-nsi-form" action="#" noValidate onSubmit={handleSubmit}>
          <h3 className="nsi-popup__title">Добавление Приказа Минстроя России</h3>
...
export default OrderRussiaMinConstructionPopup;