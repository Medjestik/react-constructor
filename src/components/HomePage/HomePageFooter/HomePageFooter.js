        ...
        <div className="footer__container">
          ...
          <ul className="footer__columns">
            ...
            <li className="footer__column">
              ...
              <ul className="footer__column-links">
                <li className="footer__column-item">Почта для получения доступа:</li>
                <li className="footer__column-item">ief07@bk.ru</li>
              </ul>
            </li>
          </ul>
        </div>
        <span className="footer__copy">&copy;{new Date().getFullYear()} Все права защищены, ИЭФ&nbsp;РУТ&nbsp;(МИИТ)</span>
      </div>
    </footer>
  );
}
