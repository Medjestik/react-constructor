...
function ControlProgramRemovePopup({ isOpen, onClose, program, onRemove, isLoading, isShowError }) {
  ...
  return (
    ...
    >
      <form className="popup__form popup__form_type_small" name="control-user-remove-form" action="#" noValidate onSubmit={handleSubmit}>
        ...
        <h3 className="popup__title">Вы действительно хотите удалить ?</h3>
        <p className="popup__subtitle">{program.name || ""}</p>
...
export default ControlProgramRemovePopup; 