...
function ControlStructureRemovePopup({ isOpen, onClose, structure, onRemove, isLoading, isShowError }) {
  ...
  return (
    ...
    >
      <form className="popup__form popup__form_type_small" name="control-user-remove-form" action="#" noValidate onSubmit={handleSubmit}>
        ...
        <h3 className="popup__title">Вы действительно хотите удалить типовую структуру?</h3>
        <p className="popup__subtitle">{structure.name || ""}</p>
...
export default ControlStructureRemovePopup; 